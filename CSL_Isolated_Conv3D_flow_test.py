...
if __name__ == '__main__':
    ...
    ######################
    checkpoint = torch.load('checkpoint/csl_flow/csl_flow_resnet2d+1_epoch063.pth')
    ...
    val_loss = val_epoch(model, criterion, val_loader, device, start_epoch, logger, writer, 'Test', exp_name)
