...
from models.Conv3D import CNN3D, resnet18, resnet34, resnet50, resnet101, r2plus1d_18, r3d_18
from dataset_sign_clip import Sign_Isolated
from train import train_epoch
from validation_clip import val_epoch
from collections import OrderedDict
from tools import get_model_summary
...
# Path setting
exp_name = 'rgb_ablation_smooth'
data_path = "/scratch/jiang.so/sign/train_frames"
# data_path2 = "/home/ubuntu/workspace/data/sign/train_frames"
data_path2 = "/scratch/jiang.so/sign/val_frames"
...
if __name__ == '__main__':
    ...
    #                 attention=attention, num_classes=num_classes)
    ...
    # model = r3d_18(pretrained=True, num_classes=226)
    # load pretrained
    # # checkpoint = torch.load('pretrained/slr_resnet2d+1_epoch016.pth')
    # checkpoint = torch.load('checkpoint/rgb_ablation_conv3d/sign_resnet2d+1_epoch022.pth')
    ...
    dump_input = torch.rand((1, 3, sample_duration, sample_size, sample_size))
