...
from dataset_wlasl_flow import Sign_Isolated
...
# Path setting
exp_name = 'csl_flow_test'
data_path = "/scratch/jiang.so/data/CSL/flow_all"
...
if __name__ == '__main__':
    ...
    model = flow_r2plus1d_18(pretrained=False, num_classes=500)
    # load pretrained
    # checkpoint = torch.load('final_models/flow_color_finetune2_epoch30.pth')
    checkpoint = torch.load('checkpoint/csl_flow/epoch043.pth')
    start_epoch = 43
    ...
    if phase == 'Train' and start_epoch == 0:
