...
data_path = "/home/ubuntu/workspace/data/sign/train_frames"
...
# label_val_path = "data/val_pred_9606.csv"
...
if __name__ == '__main__':
    ...
    if phase == 'Train':
        ...
        val_loss = val_epoch(model, criterion, val_loader, device, 0, logger, writer)
