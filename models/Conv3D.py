...
def resnet18(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        #     progress=progress)
        # checkpoint = torch.load('pretrained/kinetics_resnet_18_RGB_16_best.pth')
        checkpoint = torch.load('pretrained/resnet-18-kinetics.pth')
...
def resnet50(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        #     progress=progress)
        # checkpoint = torch.load('pretrained/kinetics_resnet_50_RGB_16_best.pth')
        # state_dict = checkpoint['state_dict']
        checkpoint = torch.load('checkpoint/slr_resnet50_epoch010.pth')
