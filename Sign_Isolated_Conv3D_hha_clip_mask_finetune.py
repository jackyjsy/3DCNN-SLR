...
# Path setting
exp_name = 'depth_hha_final_finetue2'
data_path = "/scratch/jiang.so/sign/train_val_hha_2_mask"
# data_path2 = "/home/ubuntu/data/sign/train_hha"
# data_path2 = "/scratch/jiang.so/sign/val_hha_2_mask"
data_path2 = "/scratch/jiang.so/sign/test_hha_2_mask"
...
label_val_path = "data/test_pred_corrected4.csv"
...
if __name__ == '__main__':
    ...
    # checkpoint = torch.load('checkpoint/swish_smooth_dropout_pretrained_clip_hha/sign_resnet2d+1_epoch058.pth') #47 58
    checkpoint = torch.load('final_models/val_depth_hha_final_cont_epoch_029_9513.pth')
