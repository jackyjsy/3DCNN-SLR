...
# Path setting
exp_name = 'wlasl_flow_test'
data_path = "/scratch/jiang.so/data/WLASL/flow"

label_train_path = "/scratch/jiang.so/data/WLASL/annotations/train_labels.csv"
label_val_path = "/scratch/jiang.so/data/WLASL/annotations/val_labels.csv"
...
if __name__ == '__main__':
    ...
    model = flow_r2plus1d_18(pretrained=False, num_classes=2000)
    # load pretrained
    # checkpoint = torch.load('final_models/flow_color_finetune2_epoch30.pth')
    checkpoint = torch.load('checkpoint/wlasl_flow/epoch104.pth')
    start_epoch = 104
